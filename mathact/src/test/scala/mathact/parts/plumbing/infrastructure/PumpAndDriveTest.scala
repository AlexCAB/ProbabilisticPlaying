...
import mathact.parts.bricks.{UIControl, OnStart, OnStop, WorkbenchContext}
...
class PumpAndDriveTest extends ActorTestSpec{
  ...
  trait TestCase extends Suite{
    ...
    lazy val testWorkbenchContext =
      new WorkbenchContext(system, testController.ref, testPumping.ref, testPumpConfig, ConfigFactory.load()){

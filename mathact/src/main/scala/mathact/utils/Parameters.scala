...
class Parameters {
  ...
  //Buttons
  object Buttons extends FlowFrame with SingleButton{
    val singleButtonHeight = 22
    val singleButtonFont = new Font(Font.SERIF, Font.BOLD, 16)
    val backgroundColor = Color.WHITE}
  //XTracer
  ...
  object SwitchBoard extends GridFrame with Switch{
    ...
    val nameHeight = 38}
  //SamIamBayesNet
  object SamIamBayesNet extends TVFrame with SimpleGraph with ResetButton with ReloadButton{
    ...
    val resetButtonIcon:ImageIcon = new ImageIcon(getClass.getResource("/reset.png"))
    val resetButtonSize:Int = 28
    val reloadButtonIcon:ImageIcon = new ImageIcon(getClass.getResource("/reload.png"))
    val reloadButtonSize:Int = 28}
  //SamIamCalc
  object SamIamCalc extends TVFrame with SimpleGraph with ReloadButton {
    val defaultNodeColor = Color.LIGHT_GRAY
    val evidenceNodeColor =  new Color(0,0,255)
    val activeNodeColor = new Color(255,0,0)
    val passiveNodeColor = new Color(0,255,0)
    val defaultNodeSize = 15
    ...
    val border = Some((Color.GRAY, 1))
    val backgroundColor = Color.GRAY
    val reloadButtonIcon:ImageIcon = new ImageIcon(getClass.getResource("/reset.png"))
    val reloadButtonSize:Int = 28}
  //PacmanUI
